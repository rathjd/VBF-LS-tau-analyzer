...
Signal.RequireTriggers          = true;       //require at least one of the triggers fired
...
InvertedVBF_CR2.RequireTriggers         = true;       //require at least one of the triggers fired
...
oneTightTau_CR3.RequireTriggers         = true;       //require at least one of the triggers fired
...
InvertedVBF_oneTightTau_CR4.RequireTriggers             = true;       //require at least one of the triggers fired
...
AntiTightTau_CR5.RequireTriggers                = true;       //require at least one of the triggers fired
...
InvertedVBF_AntiTightTau_CR6.RequireTriggers            = true;       //require at least one of the triggers fired
...
AntiMediumTau_CR7.RequireTriggers       = true;       //require at least one of the triggers fired
...
InvertedVBF_AntiMediumTau_CR8.RequireTriggers           = true;       //require at least one of the triggers fired
...
AntiLooseTau_CR9.RequireTriggers        = true;       //require at least one of the triggers fired
...
InvertedVBF_AntiLooseTau_CR10.RequireTriggers           = true;       //require at least one of the triggers fired
