...
void selectVariables(itreestream& stream)
{
  ...
  stream.select("npattau_patTaus", ntau);
  ...
  stream.select("pattau_patTaus.charge", tau_charge);
  stream.select("pattau_patTaus.energy", tau_energy);
  stream.select("pattau_patTaus.et", tau_et);
  stream.select("pattau_patTaus.eta", tau_eta);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_energy", tau_leadPFChargedHadrCand_energy);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_et", tau_leadPFChargedHadrCand_et);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_eta", tau_leadPFChargedHadrCand_eta);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_mass", tau_leadPFChargedHadrCand_mass);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_massSqr", tau_leadPFChargedHadrCand_massSqr);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_mt", tau_leadPFChargedHadrCand_mt);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_mtSqr", tau_leadPFChargedHadrCand_mtSqr);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_p", tau_leadPFChargedHadrCand_p);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_phi", tau_leadPFChargedHadrCand_phi);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_pt", tau_leadPFChargedHadrCand_pt);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_px", tau_leadPFChargedHadrCand_px);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_py", tau_leadPFChargedHadrCand_py);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_pz", tau_leadPFChargedHadrCand_pz);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_rapidity", tau_leadPFChargedHadrCand_rapidity);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_theta", tau_leadPFChargedHadrCand_theta);
  stream.select("pattau_patTaus.leadPFChargedHadrCand_y", tau_leadPFChargedHadrCand_y);
  stream.select("pattau_patTaus.p", tau_p);
  stream.select("pattau_patTaus.phi", tau_phi);
  stream.select("pattau_patTaus.pt", tau_pt);
  stream.select("pattau_patTaus.px", tau_px);
  stream.select("pattau_patTaus.py", tau_py);
  stream.select("pattau_patTaus.pz", tau_pz);
  stream.select("pattau_patTaus.signalPFChargedHadrCands_size", tau_signalPFChargedHadrCands_size);
  stream.select("pattau_patTaus.tauID_againstElectronDeadECAL", tau_tauID_againstElectronDeadECAL);
  stream.select("pattau_patTaus.tauID_againstElectronLoose", tau_tauID_againstElectronLoose);
  stream.select("pattau_patTaus.tauID_againstElectronLooseMVA2", tau_tauID_againstElectronLooseMVA2);
  stream.select("pattau_patTaus.tauID_againstElectronLooseMVA3", tau_tauID_againstElectronLooseMVA3);
  stream.select("pattau_patTaus.tauID_againstElectronMVA", tau_tauID_againstElectronMVA);
  stream.select("pattau_patTaus.tauID_againstElectronMVA2category", tau_tauID_againstElectronMVA2category);
  stream.select("pattau_patTaus.tauID_againstElectronMVA2raw", tau_tauID_againstElectronMVA2raw);
  stream.select("pattau_patTaus.tauID_againstElectronMVA3category", tau_tauID_againstElectronMVA3category);
  stream.select("pattau_patTaus.tauID_againstElectronMVA3raw", tau_tauID_againstElectronMVA3raw);
  stream.select("pattau_patTaus.tauID_againstElectronMedium", tau_tauID_againstElectronMedium);
  stream.select("pattau_patTaus.tauID_againstElectronMediumMVA2", tau_tauID_againstElectronMediumMVA2);
  stream.select("pattau_patTaus.tauID_againstElectronMediumMVA3", tau_tauID_againstElectronMediumMVA3);
  stream.select("pattau_patTaus.tauID_againstElectronTight", tau_tauID_againstElectronTight);
  stream.select("pattau_patTaus.tauID_againstElectronTightMVA2", tau_tauID_againstElectronTightMVA2);
  stream.select("pattau_patTaus.tauID_againstElectronTightMVA3", tau_tauID_againstElectronTightMVA3);
  stream.select("pattau_patTaus.tauID_againstElectronVLooseMVA2", tau_tauID_againstElectronVLooseMVA2);
  stream.select("pattau_patTaus.tauID_againstElectronVTightMVA3", tau_tauID_againstElectronVTightMVA3);
  stream.select("pattau_patTaus.tauID_againstMuonLoose", tau_tauID_againstMuonLoose);
  stream.select("pattau_patTaus.tauID_againstMuonLoose2", tau_tauID_againstMuonLoose2);
  stream.select("pattau_patTaus.tauID_againstMuonMedium", tau_tauID_againstMuonMedium);
  stream.select("pattau_patTaus.tauID_againstMuonMedium2", tau_tauID_againstMuonMedium2);
  stream.select("pattau_patTaus.tauID_againstMuonTight", tau_tauID_againstMuonTight);
  stream.select("pattau_patTaus.tauID_againstMuonTight2", tau_tauID_againstMuonTight2);
  stream.select("pattau_patTaus.tauID_byCombinedIsolationDeltaBetaCorrRaw", tau_tauID_byCombinedIsolationDeltaBetaCorrRaw);
  stream.select("pattau_patTaus.tauID_byCombinedIsolationDeltaBetaCorrRaw3Hits", tau_tauID_byCombinedIsolationDeltaBetaCorrRaw3Hits);
  stream.select("pattau_patTaus.tauID_byIsolationMVA2raw", tau_tauID_byIsolationMVA2raw);
  stream.select("pattau_patTaus.tauID_byIsolationMVAraw", tau_tauID_byIsolationMVAraw);
  stream.select("pattau_patTaus.tauID_byLooseCombinedIsolationDeltaBetaCorr", tau_tauID_byLooseCombinedIsolationDeltaBetaCorr);
  stream.select("pattau_patTaus.tauID_byLooseCombinedIsolationDeltaBetaCorr3Hits", tau_tauID_byLooseCombinedIsolationDeltaBetaCorr3Hits);
  stream.select("pattau_patTaus.tauID_byLooseIsolation", tau_tauID_byLooseIsolation);
  stream.select("pattau_patTaus.tauID_byLooseIsolationDeltaBetaCorr", tau_tauID_byLooseIsolationDeltaBetaCorr);
  stream.select("pattau_patTaus.tauID_byLooseIsolationMVA", tau_tauID_byLooseIsolationMVA);
  stream.select("pattau_patTaus.tauID_byLooseIsolationMVA2", tau_tauID_byLooseIsolationMVA2);
  stream.select("pattau_patTaus.tauID_byMediumCombinedIsolationDeltaBetaCorr", tau_tauID_byMediumCombinedIsolationDeltaBetaCorr);
  stream.select("pattau_patTaus.tauID_byMediumCombinedIsolationDeltaBetaCorr3Hits", tau_tauID_byMediumCombinedIsolationDeltaBetaCorr3Hits);
  stream.select("pattau_patTaus.tauID_byMediumIsolation", tau_tauID_byMediumIsolation);
  stream.select("pattau_patTaus.tauID_byMediumIsolationDeltaBetaCorr", tau_tauID_byMediumIsolationDeltaBetaCorr);
  stream.select("pattau_patTaus.tauID_byMediumIsolationMVA", tau_tauID_byMediumIsolationMVA);
  stream.select("pattau_patTaus.tauID_byMediumIsolationMVA2", tau_tauID_byMediumIsolationMVA2);
  stream.select("pattau_patTaus.tauID_byTightCombinedIsolationDeltaBetaCorr", tau_tauID_byTightCombinedIsolationDeltaBetaCorr);
  stream.select("pattau_patTaus.tauID_byTightCombinedIsolationDeltaBetaCorr3Hits", tau_tauID_byTightCombinedIsolationDeltaBetaCorr3Hits);
  stream.select("pattau_patTaus.tauID_byTightIsolation", tau_tauID_byTightIsolation);
  stream.select("pattau_patTaus.tauID_byTightIsolationDeltaBetaCorr", tau_tauID_byTightIsolationDeltaBetaCorr);
  stream.select("pattau_patTaus.tauID_byTightIsolationMVA", tau_tauID_byTightIsolationMVA);
  stream.select("pattau_patTaus.tauID_byTightIsolationMVA2", tau_tauID_byTightIsolationMVA2);
  stream.select("pattau_patTaus.tauID_byVLooseCombinedIsolationDeltaBetaCorr", tau_tauID_byVLooseCombinedIsolationDeltaBetaCorr);
  stream.select("pattau_patTaus.tauID_byVLooseIsolation", tau_tauID_byVLooseIsolation);
  stream.select("pattau_patTaus.tauID_byVLooseIsolationDeltaBetaCorr", tau_tauID_byVLooseIsolationDeltaBetaCorr);
  stream.select("pattau_patTaus.tauID_decayModeFinding", tau_tauID_decayModeFinding);
