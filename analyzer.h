...
double	beamppot_y0;
double	beamppot_z0;
std::vector<double>	electron_caloIso(7,0);
std::vector<double>	electron_charge(7,0);
std::vector<double>	electron_deltaEtaSuperClusterTrackAtVtx(7,0);
std::vector<double>	electron_deltaPhiSuperClusterTrackAtVtx(7,0);
std::vector<double>	electron_dr04EcalRecHitSumEt(7,0);
std::vector<double>	electron_dr04TkSumPt(7,0);
std::vector<double>	electron_eSuperClusterOverP(7,0);
std::vector<double>	electron_ecalIso(7,0);
std::vector<double>	electron_energy(7,0);
std::vector<double>	electron_et(7,0);
std::vector<double>	electron_eta(7,0);
std::vector<double>	electron_gsfTrack_d0(7,0);
std::vector<double>	electron_gsfTrack_dxy(7,0);
std::vector<double>	electron_gsfTrack_dz(7,0);
std::vector<double>	electron_hadronicOverEm(7,0);
std::vector<double>	electron_hcalIso(7,0);
std::vector<double>	electron_isPF(7,0);
std::vector<double>	electron_p(7,0);
std::vector<double>	electron_phi(7,0);
std::vector<double>	electron_pt(7,0);
std::vector<double>	electron_px(7,0);
std::vector<double>	electron_py(7,0);
std::vector<double>	electron_pz(7,0);
std::vector<double>	electron_scE1x5(7,0);
std::vector<double>	electron_scE2x5Max(7,0);
std::vector<double>	electron_scE5x5(7,0);
std::vector<double>	electron_trackIso(7,0);
std::vector<double>	genparticlehelper_charge(39,0);
std::vector<double>	genparticlehelper_energy(39,0);
std::vector<double>	genparticlehelper_eta(39,0);
std::vector<double>	genparticlehelper_firstDaughter(39,0);
std::vector<double>	genparticlehelper_firstMother(39,0);
std::vector<double>	genparticlehelper_lastDaughter(39,0);
std::vector<double>	genparticlehelper_lastMother(39,0);
std::vector<double>	genparticlehelper_mass(39,0);
std::vector<double>	genparticlehelper_pdgId(39,0);
std::vector<double>	genparticlehelper_phi(39,0);
std::vector<double>	genparticlehelper_pt(39,0);
std::vector<double>	genparticlehelper_status(39,0);
std::vector<double>	jet_HFEMEnergy(31,0);
std::vector<double>	jet_HFEMEnergyFraction(31,0);
std::vector<double>	jet_HFEMMultiplicity(31,0);
std::vector<double>	jet_HFHadronEnergy(31,0);
std::vector<double>	jet_HFHadronEnergyFraction(31,0);
std::vector<double>	jet_HFHadronMultiplicity(31,0);
std::vector<double>	jet_charge(31,0);
std::vector<double>	jet_chargedEmEnergyFraction(31,0);
std::vector<double>	jet_chargedHadronEnergyFraction(31,0);
std::vector<double>	jet_chargedHadronMultiplicity(31,0);
std::vector<double>	jet_chargedMuEnergy(31,0);
std::vector<double>	jet_chargedMuEnergyFraction(31,0);
std::vector<double>	jet_electronEnergy(31,0);
std::vector<double>	jet_electronEnergyFraction(31,0);
std::vector<double>	jet_electronMultiplicity(31,0);
std::vector<double>	jet_energy(31,0);
std::vector<double>	jet_et(31,0);
std::vector<double>	jet_eta(31,0);
std::vector<double>	jet_hadronFlavour(31,0);
std::vector<double>	jet_muonEnergy(31,0);
std::vector<double>	jet_muonEnergyFraction(31,0);
std::vector<double>	jet_neutralEmEnergyFraction(31,0);
std::vector<double>	jet_neutralHadronEnergy(31,0);
std::vector<double>	jet_neutralHadronEnergyFraction(31,0);
std::vector<double>	jet_neutralHadronMultiplicity(31,0);
std::vector<double>	jet_neutralMultiplicity(31,0);
std::vector<double>	jet_numberOfDaughters(31,0);
std::vector<double>	jet_p(31,0);
std::vector<double>	jet_partonFlavour(31,0);
std::vector<double>	jet_phi(31,0);
std::vector<double>	jet_photonEnergy(31,0);
std::vector<double>	jet_photonEnergyFraction(31,0);
std::vector<double>	jet_photonMultiplicity(31,0);
std::vector<double>	jet_pt(31,0);
...
std::vector<double>	muon_eta(11,0);
std::vector<double>	muon_globalTrack_hitPattern_numberOfValidMuonHits(11,0);
std::vector<double>	muon_globalTrack_normalizedChi2(11,0);
std::vector<double>	muon_innerTrack_dxy(11,0);
std::vector<double>	muon_innerTrack_dz(11,0);
std::vector<double>	muon_innerTrack_hitPattern_numberOfValidPixelHits(11,0);
std::vector<double>	muon_innerTrack_hitPattern_pixelLayersWithMeasurement(11,0);
std::vector<double>	muon_innerTrack_normalizedChi2(11,0);
std::vector<double>	muon_isGlobalMuon(11,0);
std::vector<double>	muon_isPFMuon(11,0);
std::vector<double>	muon_isTrackerMuon(11,0);
std::vector<double>	muon_muonBestTrack_dxy(11,0);
std::vector<double>	muon_muonBestTrack_dz(11,0);
std::vector<double>	muon_numberOfMatchedStations(11,0);
std::vector<double>	muon_p(11,0);
std::vector<double>	muon_pfIsolationR03_sumChargedHadronPt(11,0);
std::vector<double>	muon_pfIsolationR03_sumChargedParticlePt(11,0);
std::vector<double>	muon_pfIsolationR03_sumNeutralHadronEt(11,0);
std::vector<double>	muon_pfIsolationR03_sumNeutralHadronEtHighThreshold(11,0);
std::vector<double>	muon_pfIsolationR03_sumPUPt(11,0);
std::vector<double>	muon_pfIsolationR03_sumPhotonEt(11,0);
std::vector<double>	muon_pfIsolationR03_sumPhotonEtHighThreshold(11,0);
std::vector<double>	muon_pfIsolationR04_sumChargedHadronPt(11,0);
std::vector<double>	muon_pfIsolationR04_sumChargedParticlePt(11,0);
std::vector<double>	muon_pfIsolationR04_sumNeutralHadronEt(11,0);
std::vector<double>	muon_pfIsolationR04_sumNeutralHadronEtHighThreshold(11,0);
std::vector<double>	muon_pfIsolationR04_sumPUPt(11,0);
std::vector<double>	muon_pfIsolationR04_sumPhotonEt(11,0);
std::vector<double>	muon_pfIsolationR04_sumPhotonEtHighThreshold(11,0);
std::vector<double>	muon_phi(11,0);
std::vector<double>	muon_pt(11,0);
std::vector<double>	muon_px(11,0);
std::vector<double>	muon_py(11,0);
std::vector<double>	muon_pz(11,0);
int	nelectron;
...
int	ntau;
int	nvertex;
std::vector<double>	tau_charge(7,0);
std::vector<double>	tau_energy(7,0);
std::vector<double>	tau_et(7,0);
std::vector<double>	tau_eta(7,0);
std::vector<double>	tau_leadChargedHadrCand_energy(7,0);
std::vector<double>	tau_leadChargedHadrCand_et(7,0);
std::vector<double>	tau_leadChargedHadrCand_eta(7,0);
std::vector<double>	tau_leadChargedHadrCand_mass(7,0);
std::vector<double>	tau_leadChargedHadrCand_massSqr(7,0);
std::vector<double>	tau_leadChargedHadrCand_mt(7,0);
std::vector<double>	tau_leadChargedHadrCand_mtSqr(7,0);
std::vector<double>	tau_leadChargedHadrCand_p(7,0);
std::vector<double>	tau_leadChargedHadrCand_phi(7,0);
std::vector<double>	tau_leadChargedHadrCand_pt(7,0);
std::vector<double>	tau_leadChargedHadrCand_px(7,0);
std::vector<double>	tau_leadChargedHadrCand_py(7,0);
std::vector<double>	tau_leadChargedHadrCand_pz(7,0);
...
std::vector<double>	tau_px(7,0);
std::vector<double>	tau_py(7,0);
std::vector<double>	tau_pz(7,0);
std::vector<double>	tau_tauID_againstElectronLoose(7,0);
std::vector<double>	tau_tauID_againstElectronLooseMVA5(7,0);
std::vector<double>	tau_tauID_againstElectronMVA5category(7,0);
std::vector<double>	tau_tauID_againstElectronMVA5raw(7,0);
std::vector<double>	tau_tauID_againstElectronMedium(7,0);
std::vector<double>	tau_tauID_againstElectronMediumMVA5(7,0);
std::vector<double>	tau_tauID_againstElectronTight(7,0);
std::vector<double>	tau_tauID_againstElectronTightMVA5(7,0);
std::vector<double>	tau_tauID_againstElectronVLooseMVA5(7,0);
std::vector<double>	tau_tauID_againstElectronVTightMVA5(7,0);
std::vector<double>	tau_tauID_againstMuonLoose(7,0);
std::vector<double>	tau_tauID_againstMuonLoose2(7,0);
std::vector<double>	tau_tauID_againstMuonLoose3(7,0);
std::vector<double>	tau_tauID_againstMuonLooseMVA(7,0);
std::vector<double>	tau_tauID_againstMuonMVAraw(7,0);
std::vector<double>	tau_tauID_againstMuonMedium(7,0);
std::vector<double>	tau_tauID_againstMuonMedium2(7,0);
std::vector<double>	tau_tauID_againstMuonMediumMVA(7,0);
std::vector<double>	tau_tauID_againstMuonTight(7,0);
std::vector<double>	tau_tauID_againstMuonTight2(7,0);
std::vector<double>	tau_tauID_againstMuonTight3(7,0);
std::vector<double>	tau_tauID_againstMuonTightMVA(7,0);
std::vector<double>	tau_tauID_byCombinedIsolationDeltaBetaCorrRaw3Hits(7,0);
std::vector<double>	tau_tauID_byIsolationMVA3newDMwLTraw(7,0);
std::vector<double>	tau_tauID_byIsolationMVA3newDMwoLTraw(7,0);
std::vector<double>	tau_tauID_byIsolationMVA3oldDMwLTraw(7,0);
std::vector<double>	tau_tauID_byIsolationMVA3oldDMwoLTraw(7,0);
std::vector<double>	tau_tauID_byLooseCombinedIsolationDeltaBetaCorr3Hits(7,0);
std::vector<double>	tau_tauID_byLooseIsolationMVA3newDMwLT(7,0);
std::vector<double>	tau_tauID_byLooseIsolationMVA3newDMwoLT(7,0);
std::vector<double>	tau_tauID_byLooseIsolationMVA3oldDMwLT(7,0);
std::vector<double>	tau_tauID_byLooseIsolationMVA3oldDMwoLT(7,0);
std::vector<double>	tau_tauID_byMediumCombinedIsolationDeltaBetaCorr3Hits(7,0);
std::vector<double>	tau_tauID_byMediumIsolationMVA3newDMwLT(7,0);
std::vector<double>	tau_tauID_byMediumIsolationMVA3newDMwoLT(7,0);
std::vector<double>	tau_tauID_byMediumIsolationMVA3oldDMwLT(7,0);
std::vector<double>	tau_tauID_byMediumIsolationMVA3oldDMwoLT(7,0);
std::vector<double>	tau_tauID_byTightCombinedIsolationDeltaBetaCorr3Hits(7,0);
std::vector<double>	tau_tauID_byTightIsolationMVA3newDMwLT(7,0);
std::vector<double>	tau_tauID_byTightIsolationMVA3newDMwoLT(7,0);
std::vector<double>	tau_tauID_byTightIsolationMVA3oldDMwLT(7,0);
std::vector<double>	tau_tauID_byTightIsolationMVA3oldDMwoLT(7,0);
std::vector<double>	tau_tauID_byVLooseIsolationMVA3newDMwLT(7,0);
std::vector<double>	tau_tauID_byVLooseIsolationMVA3newDMwoLT(7,0);
std::vector<double>	tau_tauID_byVLooseIsolationMVA3oldDMwLT(7,0);
std::vector<double>	tau_tauID_byVLooseIsolationMVA3oldDMwoLT(7,0);
std::vector<double>	tau_tauID_byVTightIsolationMVA3newDMwLT(7,0);
std::vector<double>	tau_tauID_byVTightIsolationMVA3newDMwoLT(7,0);
std::vector<double>	tau_tauID_byVTightIsolationMVA3oldDMwLT(7,0);
std::vector<double>	tau_tauID_byVTightIsolationMVA3oldDMwoLT(7,0);
std::vector<double>	tau_tauID_byVVTightIsolationMVA3newDMwLT(7,0);
std::vector<double>	tau_tauID_byVVTightIsolationMVA3newDMwoLT(7,0);
std::vector<double>	tau_tauID_byVVTightIsolationMVA3oldDMwLT(7,0);
std::vector<double>	tau_tauID_byVVTightIsolationMVA3oldDMwoLT(7,0);
std::vector<double>	tau_tauID_chargedIsoPtSum(7,0);
std::vector<double>	tau_tauID_decayModeFinding(7,0);
std::vector<double>	tau_tauID_decayModeFindingNewDMs(7,0);
std::vector<double>	tau_tauID_neutralIsoPtSum(7,0);
std::vector<double>	tau_tauID_puCorrPtSum(7,0);
std::vector<double>	vertex_chi2(35,0);
...
std::vector<genparticlehelper_s> genparticlehelper(39);
...
{
  double	HFEMEnergy;
  double	HFEMEnergyFraction;
  double	HFEMMultiplicity;
  double	HFHadronEnergy;
  double	HFHadronEnergyFraction;
...
struct tau_s
{
  ...
  double	leadChargedHadrCand_mass;
  double	leadChargedHadrCand_massSqr;
  double	leadChargedHadrCand_mt;
  double	leadChargedHadrCand_mtSqr;
  double	leadChargedHadrCand_p;
  double	leadChargedHadrCand_phi;
  double	leadChargedHadrCand_pt;
  ...
  double	py;
  double	pz;
  double	tauID_againstElectronLoose;
  double	tauID_againstElectronLooseMVA5;
  double	tauID_againstElectronMVA5category;
  double	tauID_againstElectronMVA5raw;
  double	tauID_againstElectronMedium;
  double	tauID_againstElectronMediumMVA5;
  double	tauID_againstElectronTight;
  double	tauID_againstElectronTightMVA5;
  double	tauID_againstElectronVLooseMVA5;
  double	tauID_againstElectronVTightMVA5;
  double	tauID_againstMuonLoose;
  double	tauID_againstMuonLoose2;
  double	tauID_againstMuonLoose3;
  double	tauID_againstMuonLooseMVA;
  double	tauID_againstMuonMVAraw;
  double	tauID_againstMuonMedium;
  double	tauID_againstMuonMedium2;
  double	tauID_againstMuonMediumMVA;
  double	tauID_againstMuonTight;
  double	tauID_againstMuonTight2;
  double	tauID_againstMuonTight3;
  double	tauID_againstMuonTightMVA;
  double	tauID_byCombinedIsolationDeltaBetaCorrRaw3Hits;
  double	tauID_byIsolationMVA3newDMwLTraw;
  double	tauID_byIsolationMVA3newDMwoLTraw;
  double	tauID_byIsolationMVA3oldDMwLTraw;
  double	tauID_byIsolationMVA3oldDMwoLTraw;
  double	tauID_byLooseCombinedIsolationDeltaBetaCorr3Hits;
  double	tauID_byLooseIsolationMVA3newDMwLT;
  double	tauID_byLooseIsolationMVA3newDMwoLT;
  double	tauID_byLooseIsolationMVA3oldDMwLT;
  double	tauID_byLooseIsolationMVA3oldDMwoLT;
  double	tauID_byMediumCombinedIsolationDeltaBetaCorr3Hits;
  double	tauID_byMediumIsolationMVA3newDMwLT;
  double	tauID_byMediumIsolationMVA3newDMwoLT;
  double	tauID_byMediumIsolationMVA3oldDMwLT;
  double	tauID_byMediumIsolationMVA3oldDMwoLT;
  double	tauID_byTightCombinedIsolationDeltaBetaCorr3Hits;
  double	tauID_byTightIsolationMVA3newDMwLT;
  double	tauID_byTightIsolationMVA3newDMwoLT;
  double	tauID_byTightIsolationMVA3oldDMwLT;
  double	tauID_byTightIsolationMVA3oldDMwoLT;
  double	tauID_byVLooseIsolationMVA3newDMwLT;
  double	tauID_byVLooseIsolationMVA3newDMwoLT;
  double	tauID_byVLooseIsolationMVA3oldDMwLT;
  double	tauID_byVLooseIsolationMVA3oldDMwoLT;
  double	tauID_byVTightIsolationMVA3newDMwLT;
  double	tauID_byVTightIsolationMVA3newDMwoLT;
  double	tauID_byVTightIsolationMVA3oldDMwLT;
  double	tauID_byVTightIsolationMVA3oldDMwoLT;
  double	tauID_byVVTightIsolationMVA3newDMwLT;
  double	tauID_byVVTightIsolationMVA3newDMwoLT;
  double	tauID_byVVTightIsolationMVA3oldDMwLT;
  double	tauID_byVVTightIsolationMVA3oldDMwoLT;
  double	tauID_chargedIsoPtSum;
  double	tauID_decayModeFinding;
  double	tauID_decayModeFindingNewDMs;
  double	tauID_neutralIsoPtSum;
  double	tauID_puCorrPtSum;
};
...
{
  vertex.resize(vertex_chi2.size());
