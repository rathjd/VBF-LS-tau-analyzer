...
TH1::SetDefaultSumw2();
TFile file_eff("/afs/naf.desy.de/user/r/rathjd/public/VBFAnalyzer/effmap_coarse.root", "read");
...
if(!( fabs(jet[j].eta) <= 2.9 )) continue;
...
if(scale==0) scale=1; //exception for jet eta > tau eta max 
